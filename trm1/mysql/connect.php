...
$server = "mysql:host=localhost;dbname=my_data"; //  mysql = اول مشخص میکنیم به چه دیتابیسی میخواییم متصل بشیم
...
try {
    ...
    echo $e->getMessage(); // ارور ایجاد شده رو به ما نمایشمیده
}
return $pdo;
...
$query= $pdo->prepare("SELECT * FROM users_tbl"); // داخل prepare میتونیم کدهای sql استفاده بنویسیم
$query->execute();  //  کد رو اجرا میکنه
